<template>
  <div style="margin-bottom:60px">
    ...
    <ion-button expand="block" disabled="true" v-if="patrolEndBtn">巡查中</ion-button>
    <ion-button expand="block" disabled="true" v-if="!patrolEndBtn">本次巡查已结束</ion-button>
    ...
    <ion-button expand="block" color="danger" @click="confirmEnd" v-if="patrolEndBtn">结束巡查</ion-button>
    <TabBar/>
  </div>
</template>
